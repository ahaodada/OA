...
<script type="text/javascript">
    ...
    $("#btn_delete").click(function () {
        ...
        if (ids.length < 1) {
            ...
            layer.confirm('确定删除这些公告吗?？', {
                ...
                //确定按钮的回调函数
                var url = "${pageContext.request.contextPath}/notice/removeNotice";
                var params = {
                    flag: 2,
                    ids: ids
                }
                $.ajax({
                    ...
                    dataType: "json",
                    error: function () {
                        $("#table").bootstrapTable("refresh", {url: '${ctx}/ajson'});
    ...
    function deleteone(id) {
        layer.confirm('确定删除这条公告吗?？', {
            ...
            //确定按钮的回调函数
            window.location.href = "${pageContext.request.contextPath}/notice/removeNotice?flag=1&id=" + id;
        })
//        },function () {
//			//取消按钮的回调函数
//        }
