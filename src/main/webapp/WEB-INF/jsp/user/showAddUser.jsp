...
<div class="layui-form" id="userForm">
    ...
    <div class="form-group-sm">
        <label>登录名:<input class="form-control" type="text" name="loginame" id="loginame"
                          lay-verify="loginame"></label>&nbsp;&nbsp;
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data == "success") {
                        ...
                        setTimeout(function () {
                            window.location.href = "${ctx}/selectUser.action";
                        }, 2000);
                    }
                },
                error: function () {
